...
class GeneratorFactory:
    ...
    def create_generator(
        ...
        if generator_type == 'replay':
            ...
            from .markov.markov_generator import MarkovGenerator

            # Passamos a config inteira, pois o MarkovGenerator extrai
            # 'max_states' e outras chaves diretamente dela.
            return MarkovGenerator(config, parser)
